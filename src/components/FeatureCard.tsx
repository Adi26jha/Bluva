...
const FeatureCard = ({ icon: Icon, title, description }: FeatureCardProps) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover={{ y: -5 }}
      className="glass-card-dark p-8 border-slate-200 group hover:border-brand-blue/30 transition-all duration-500"
    >
      ...
      <h3 className="text-2xl font-editorial font-bold text-slate-900 mb-3 group-hover:text-brand-blue transition-colors">
        {title}
      </h3>
