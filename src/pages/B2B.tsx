    ...
    <div className="pt-24 bg-navy-base">
      ...
      <section className="container mx-auto px-6 py-32 text-center lg:text-left grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p className="text-white/40 text-xl max-w-lg leading-relaxed">
          ...
          <div className="flex flex-wrap gap-8 pt-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-white/60">Tiered Pricing</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle size={20} className="text-brand-blue" />
              <span className="text-sm font-bold uppercase tracking-widest text-white/60">Reliable Supply</span>
            </div>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              ...
              >
                ...
                <h3 className="text-4xl md:text-5xl font-editorial font-bold text-white">{stat.value}</h3>
      ...
      <section className="py-32 container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-white/40">Why distributors choose BLUVA</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div
              key={i}
              whileHover={{ x: 10 }}
              className="glass-card-dark p-12 border-white/5 flex gap-8"
            >
            ...
            >
              {isSubmitSuccessful ? (
                <div className="text-center py-20 space-y-6">
                  ...
                  <p className="text-white/50">Thank you for your interest in BLUVA. Our team will contact you shortly.</p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-xs uppercase tracking-widest text-white/40">Contact Person</label>
                      <input 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-xs uppercase tracking-widest text-white/40">Monthly Requirement</label>
                      <select 
